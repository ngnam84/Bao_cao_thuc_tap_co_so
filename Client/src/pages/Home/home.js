                    ...
                    <Row justify="center" align="top" key="1" >
                        ...
                        <Col span={15}>
                            <Carousel autoplay className="carousel-image">
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src={process.env.PUBLIC_URL + "/banner-thoi-trang-bi-an1.jpg"} alt="Banner thời trang bí ẩn" />
                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src={process.env.PUBLIC_URL + "/banner-thoi-trang-da-dang.jpg"} alt="Banner thời trang đa dạng" />
                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src={process.env.PUBLIC_URL + "/dung-luong-banner-thoi-trang.jpg"} alt="Banner dung lượng thời trang" />
                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src={process.env.PUBLIC_URL + "/logo-banner-thoi-trang.jpg"} alt="Banner logo thời trang" />
                                </div>
                            </Carousel>
