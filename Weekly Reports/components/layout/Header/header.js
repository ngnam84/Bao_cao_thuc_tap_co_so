...
function Topbar() {
  ...
  return (
    ...
    >
      ...
      <img style={{ color: "#000000", fontSize: 15, height: 55, cursor: "pointer" }} src="https://pos.nvncdn.com/d0f3ca-7136/store/20230906_9BHMhQjv.png" onClick={() => handleLink("/home")}></img>  
        </NavLink>    
      </div>
